...
if __name__ == "__main__":
    ...
    email_sender="nikshithansi@gmail.com"
    password="punelppttrhtjxsu"
    subject="Automate Attendence "
    with open(r'D:\Mini_Project\MINE\projectfol\completeData\Mail\mail.csv','r') as csvfile:
        ...
        for line in reader:
            ...
            today = time.strftime('%d_%m_%Y')
            record_file = f"/home/nikshitsaini/Documents/VS COde/practicals/cgl/project pbl/Records/Record_{today}.csv"
